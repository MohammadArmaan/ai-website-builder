...
function ElementSettingSection({ selectedEl }: Props) {
    ...
    return (
        <div className='w-full lg:w-96 shadow p-4 space-y-4 overflow-auto h-[90vh] rounded-xl mt-2 mr-2'>
            ...
            <div className="flex items-center gap-4">
                ...
                <div>
                    ...
                    <Input type='color'
                        className='w-15 h-10 rounded-lg mt-1'
            ...
            <div>
                ...
                <ToggleGroup
                    ...
                    className="bg-muted-foreground/30 rounded-lg p-1 inline-flex w-full justify-between"
                >
                ...
                <div className="flex flex-wrap gap-2 mt-2">
                    {classes.length > 0 ? (
                        classes.map((cls) => (
                            <span
                                key={cls}
                                className="flex text-xs items-center gap-1 px-2 py-1 text-sm rounded-full bg-muted-foreground/30 border"
                            >
                                {cls}
                                <button
