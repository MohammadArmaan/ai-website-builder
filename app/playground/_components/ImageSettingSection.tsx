...
function ImageSettingSection({ selectedEl }: Props) {
    ...
    const applyBorderRadius = (value: string) => {
        if (selectedEl) {
    ...
    const generateAIImage = () => {
        ...
        }/ik-genimg-prompt-${altText}/${Date.now()}.png?tr=`;
    ...
    return (
        <div className="w-full lg:w-96 shadow dark:shadow-xl dark:border-l p-4 space-y-4">
